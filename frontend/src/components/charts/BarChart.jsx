    ...
    <div className="chart-frame" style={{ height }}>
      <ResponsiveContainer width="100%" height="100%">
        <ReBarChart data={data} margin={{ top: 8, right: 14, left: 0, bottom: 12 }}>
          ...
          <XAxis dataKey="label" tick={{ fontSize: 11, fill: semanticColors.tick }} tickFormatter={shortLabel} interval={0} />
          <YAxis tick={{ fontSize: 11, fill: semanticColors.tick }} tickFormatter={compactCurrency} width={52} />
